    ...
    return (
        <section className='about'>
            ...
            <div className="about-links">
                <a href="" className="about-link"><FaLinkedin className="about-icon"/> LinkedIn</a>
                <a href="" className="about-"><FaGithub className="about-icon"/> Github</a>
                <a href="" className="about-"><MdPictureAsPdf className="about-icon"/> Resume</a>
            </div>
        </section>
    )
}
